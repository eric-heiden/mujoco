...
@named_scope
def fwd_position1(m: Model, d: Data) -> Data:
  """Position-dependent computations."""
  # TODO(robotics-simulation): tendon
  d = smooth.kinematics(m, d)
  d = smooth.com_pos(m, d)
...
@named_scope
def fwd_position2(m: Model, d: Data) -> Data:
  """Position-dependent computations."""
  d = collision_driver_cuda.collision(m, d)
  return d

@named_scope
def fwd_position3(m: Model, d: Data) -> Data:
  """Position-dependent computations."""
  # TODO(robotics-simulation): tendon
  d = constraint.make_constraint(m, d)
  d = smooth.transmission(m, d)
...
@named_scope
def forward1(m: Model, d: Data) -> Data:
  """Forward dynamics."""
  d = fwd_position1(m, d)
  return d

@named_scope
def forward2(m: Model, d: Data) -> Data:
  """Forward dynamics."""
  d = fwd_position2(m, d)
  return d
...
@named_scope
def forward3(m: Model, d: Data) -> Data:
  """Forward dynamics."""
  d = fwd_position3(m, d)
  d = fwd_velocity(m, d)
  d = fwd_actuation(m, d)
...
@named_scope
def step_cuda1(m: Model, d: Data) -> Data:
  """Advance simulation."""
  d = forward1(m, d)
  return d

@named_scope
def step_cuda2(m: Model, d: Data) -> Data:
  """Advance simulation."""
  d = forward2(m, d)
  return d
...
@named_scope
def step_cuda3(m: Model, d: Data) -> Data:
  """Advance simulation."""
  d = forward3(m, d)
